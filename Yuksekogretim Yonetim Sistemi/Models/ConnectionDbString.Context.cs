...
namespace Yuksekogretim_Yonetim_Sistemi.Models
{
    ...
    public partial class YYS_DBEntities : DbContext
    {
        public YYS_DBEntities()
            : base("name=YYS_DBEntities")
        {
        }
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("NOTLISTESI");
        }
